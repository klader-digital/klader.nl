    ...
    return (
        <header className='container relative py-4 lg:py-10'>
            <nav className='flex justify-between items-center'>
                ...
                <button className='w-14 h-14 grid lg:hidden place-items-center border border-zinc-700 text-white'>
                ...
                <ul className='hidden lg:flex leading-relaxed text-sm text-zinc-400 gap-12 items-center'>
                    <li>
                    ...
                    <li>
                        <a href="#contact" className='underline underline-offset-4 hover:text-brand duration-300 decoration-[0.5px] pl-12 border-l border-zinc-700'>Get in touch 👋</a>
                    </li>
                </ul>
            </nav>
        </header>
